...
(function () {
  ...
  function injectStripStyle() {
    ...
    s.textContent = '.whats-new{display:flex;flex-wrap:nowrap;align-items:center;gap:.35rem .45rem;margin:0;padding:.55rem .1rem .55rem .65rem;border:0;border-left:2px solid var(--accent,#2563eb);background:color-mix(in srgb,var(--accent,#2563eb) 5%,transparent);font-size:.82rem;animation:navUpdateIn .35s ease-out both;overflow-x:auto;min-width:0;max-width:100%}.whats-new>*{flex-shrink:0}@media (max-width:640px){.whats-new{-webkit-mask-image:linear-gradient(to right,black 85%,transparent 100%);mask-image:linear-gradient(to right,black 85%,transparent 100%)}}@media (prefers-reduced-motion:reduce){.whats-new{animation:none}}.whats-new-label{font-family:ui-monospace,"SFMono-Regular",monospace;font-size:.75rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;opacity:.85;margin-right:.1rem}.whats-new-chip{display:inline-block;padding:.1rem .55rem;font-size:.76rem;font-weight:600;line-height:1.5;color:var(--accent,#2563eb);background:color-mix(in srgb,var(--accent,#2563eb) 10%,transparent);border:1px solid color-mix(in srgb,var(--accent,#2563eb) 28%,transparent);border-radius:999px;text-decoration:none;white-space:nowrap}.whats-new-chip:hover{background:color-mix(in srgb,var(--accent,#2563eb) 20%,transparent);text-decoration:none}.whats-new-dismiss{margin-left:auto;padding:0 .35rem;border:0;background:none;color:inherit;opacity:.55;font-size:1rem;line-height:1;cursor:pointer}.whats-new-dismiss:hover{opacity:1}';
    (document.head || document.documentElement).appendChild(s);
  }
