...
3. **For builders** — an operational action or decision.
4. **Background** — collapsible chronological context.
5. **The Arc / Timeline** — editorial beats with source evidence, or the raw
   date sequence.
...
- Arc/Timeline uses tab roles, selected state, keyboard arrow navigation, and
