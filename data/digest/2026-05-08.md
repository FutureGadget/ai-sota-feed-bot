# Daily AI SOTA Digest - 2026-05-08

Focus: AI Platform Engineering

## 1. OpenAI Introduces Websocket-Based Execution Mode to Reduce Latency in Agentic Workflows
...
## 5. Webdevbench: Evaluating AI as software development agencies
...
## 8. Google Announces GKE Agent Sandbox and Hypercluster at Next '26, Positioning Kubernetes as AI Agent
- Type: news | Source: infoq_ai_ml
...
## 9. Advancing voice intelligence with new models in the API
- Type: news | Source: openai_blog
...
## 17. Collaborate With Claude Across Excel Powerpoint Word And Outlook
