...
## 11. WinoQueer-NL: Assessing Bias in Dutch Language Models toward LGBTQ+ Identities
- Type: paper | Source: arxiv_cs_cl
- URL: http://arxiv.org/abs/2609.02651v1
- Score: 2.528 | Reliability: 1.0
- Why it matters: Matches feed focus: eval.

## 12. Getting started with Mantis, our open-source bug finding-and-fixing harness
...
## 15. frb100-40 After Two Decades: An Optimality Certificate and a Preregistered Search Study
- Type: paper | Source: arxiv_cs_ai
- URL: http://arxiv.org/abs/2609.02804v1
- Score: 2.441 | Reliability: 1.0
- Why it matters: Matches feed focus: eval.

## 16. Cloudflare Adds Optional OAuth Scopes, Letting Developers Mark What Users May Decline
...
## 17. Moonshot AI Files Confidentially for Hong Kong IPO
- Type: news | Source: search_cn_open_weight_labs
- URL: https://news.google.com/rss/articles/CBMikAFBVV95cUxOdm05Nmppd1YzX2dXNGtJTVpDWDR0VEhZVXJCejAwUXpwa3hBWmFsOG1GN251Z0lrbGN2Q2NoMzdoQWM3Ynk0SG5xazRmbFJuaXVZSnFJdGItS054UzI1WnRpUlhkd282QUdGWmFuckRWN09RTXhEWGNWY2l2ZUF6alFpSjRmd1V4bnlnMkNUb3A?oc=5
- Score: 2.284 | Reliability: 1.0
- Why it matters: 

## 18. claude-agent-sdk-python v0.2.152
...
## 20. [AINews] Claude Fable/Mythos 5.1: new SOTA model, 75% cache price cut but 70% more output tokens
- Type: news | Source: latent_space
- URL: https://www.latent.space/p/ainews-claude-fablemythos-51-new
- Score: 2.199 | Reliability: 1.0
- Why it matters: 

## 21. How Botika runs full-stack generative AI on Modal
...
## 23. Building Commerce Agents with Claude | Claude by Anthropic
- Type: news | Source: claude_blog
...
## 24. Catalyst By Zoho Redefines AI-Generated Code To Agent-Ready Cloud
