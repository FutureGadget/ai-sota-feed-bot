...
## 3. DeepSeek Harness Launches v0.1, Boosting AI Sector and Domestic Chip Industry - GuruFocus
- Type: news | Source: search_cn_open_weight_labs
- URL: https://news.google.?oc=5
- Score: 2.511 | Reliability: 1.0
- Why it matters: Matches feed focus: harness.

## 4. Found an Agent created skill that applies uncle bobs
- Type: news | Source: hackernews_ai
- URL: https://github.com/AmazingAng/old-coder
...
## 6. AWS Open-Sources Dogwood, Extending Cedar to Govern Sequences of Agent Tool Calls
...
## 7. AWS Introduces Native Vector Search for DynamoDB
- Type: news | Source: infoq_ai_ml
...
## 14. ATLAS: Discovering Agent Strategies through LLM-Guided Abstraction and Automata Learning
