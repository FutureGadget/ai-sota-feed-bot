...
- Score: 3.056 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, evaluation.

## 3. How KDDI built Buffmee, a faster, reliable consumer RAG app
...
## 5. CVE-2026-82533: DeepSeek Harness Vulnerability Lets AI Agents Escape Their Own Sandbox
- Type: news | Source: search_cn_open_weight_labs
- URL: https://news.google.com/rss/articles/CBMijgFBVV95cUxQT1ptSVFXeUQzc1gtNzhzQmpsbGJSdHd1RndnSm0zMWRkcWV5dHNVZk5pWUFzaUZyQzlPZ25GMHhRemY4cVBUUkFhU1JoeUo4Z0RWVlZVNHhnRV9mYWlBNlJXNjZUcC1Dd2dnQ0tmZVMxTkdHMEhhazFuazBQRTlWeUsxWHZwSU0zZE1UZTNn?oc=5
...
## 9. vLLM x AgentX: Optimizing for Real-World Agentic Serving
...
## 15. Presentation: Platform Engineering in the Age of AI
- Type: news | Source: infoq_ai_ml
...
## 17. Large Language Models for HVAC Operations in Building Energy Systems: A Critical Review of Methods, Applications, and Deployment Readiness
- Type: paper | Source: arxiv_cs_cl
- URL: http://arxiv.org/abs/2609.05314v1
- Score: 2.211 | Reliability: 1.0
- Why it matters: Matches feed focus: agentic, evaluation.

## 18. Benchmarking small LLM inference on SageMaker AI: G7 vs G5 and G6
...
## 19. The Frontier AEO Tracker: What Astra Chooses (and every other frontier model, and what you can do about it)
- Type: news | Source: latent_space
- URL: https://www.latent.space/p/aeo
- Score: 1.988 | Reliability: 1.0
- Why it matters: 

## 20. GLM 5.3 Optimizations, Part 1: Hybrid HiSparse Offloading in vLLM
- Type: news | Source: vllm_blog
- URL: https://vllm.ai/blog/2026-09-08-glm53-part1-hybrid-sparse-offloading
- Score: 1.974 | Reliability: 1.0
- Why it matters: 

## 21. Safety for Whom? Refusing the Right Subset of a Topic, Not the Whole Topic
...
## 22. Build durable agents with Temporal and Lakebase
...
## 23. Adaptive Gated Deepfake Detection for Low-Resolution and Resource-Constrained Environments
- Type: paper | Source: arxiv_cs_lg
- URL: http://arxiv.org/abs/2609.05320v1
- Score: 1.787 | Reliability: 1.0
- Why it matters: Matches feed focus: eval.

## 24. ACE: Adaptive Calibration-Free Expert Skipping for MoE-based LLMs
