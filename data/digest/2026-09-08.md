# Daily AI SOTA Digest - 2026-09-08

Focus: AI Platform Engineering

## 1. Quoting Jakub Pachocki
...
## 3. Refine Cycle: self-improvement plugin for Hermes Agent
- Type: news | Source: hackernews_ai
- URL: https://github.com/Bergschloss/Refine-Cycle-for-Hermes-Agent
- Score: 2.552 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 4. Presentation: From AI Agent Demo to Production: Automated Testing and Evaluation
...
## 5. DeepSeek Plans 160,000 Huawei Chips for a 1-GW Data Center
- Type: news | Source: search_cn_open_weight_labs
- URL: https://news.google.com/rss/articles/CBMimgFBVV95cUxOMUpiSnh3X2U5NHhCajROQjJqb2FPR2NPWm94X0ZaZUhRcFZGR2hVeU85eXkwdE1fSmUyWW8ySlotX0ozUEVfLUZOTjk2bWdGdG1OMG84Zi1nbXVJQjFTT3RKNDZ2TGNDUWUwTld5U3JGWUlmWE5UdG1BTDVlSThnaDdDbWk0SmV4M18zMUNfdUY1cmNteFhwVXJ3?oc=5
...
## 7. Large Language Models for HVAC Operations in Building Energy Systems: A Critical Review of Methods, Applications, and Deployment Readiness
...
## 11. GLM 5.3 Optimizations, Part 1: Hybrid HiSparse Offloading in vLLM
...
## 13. Google Mantis: an Agentic Vulnerability Scanning Harness for Reducing False Positives
- Type: news | Source: infoq_ai_ml
...
## 14. codex 0.154.0-alpha.6
- Type: release | Source: openai_codex_releases
- URL: https://github.com/openai/codex/releases/tag/rust-v0.154.0-alpha.6
- Score: 2.001 | Reliability: 1.0
- Why it matters: Matches feed focus: codex.

## 15. Adaptive Gated Deepfake Detection for Low-Resolution and Resource-Constrained Environments
- Type: paper | Source: arxiv_cs_lg
- URL: http://arxiv.org/abs/2609.05320v1
- Score: 1.871 | Reliability: 1.0
- Why it matters: Matches feed focus: eval.

## 16. Serving LLMs on Tenstorrent Hardware: Inside the vLLM TT Plugin
- Type: news | Source: vllm_blog
- URL: https://vllm.ai/blog/2026-09-07-vllm-tt-plugin
- Score: 1.839 | Reliability: 1.0
- Why it matters: 

## 17. ACE: Adaptive Calibration-Free Expert Skipping for MoE-based LLMs
- Type: paper | Source: arxiv_cs_ai
- URL: http://arxiv.org/abs/2609.05228v1
- Score: 1.804 | Reliability: 1.0
- Why it matters: Matches feed focus: eval.

## 18. Constructing and Evaluating Clinical Reasoning Trajectories for Medical Agent
- Type: paper | Source: arxiv_llm_reliability
- URL: http://arxiv.org/abs/2609.05090v1
- Score: 1.618 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, evaluation.

## 19. Formalizing Fermat's Last Theorem
...
## 20. Project HydraFusion: Frontier quality via multi-model orchestration
...
- Score: 1.565 | Reliability: 1.0
- Why it matters: Matches feed focus: evaluation.

## 21. Introducing WeatherNext 3, our most advanced and accurate global weather AI model
...
## 22. claude-code v2.1.263
- Type: release | Source: claude_code_releases
- URL: https://github.com/anthropics/claude-code/releases/tag/v2.1.263
- Score: 1.343 | Reliability: 1.0
- Why it matters: 

## 23. tencent/EVIE-8B released on Hugging Face
- Type: release | Source: hf_tencent_hunyuan_releases
- URL: https://huggingface.co/tencent/EVIE-8B
- Score: 1.311 | Reliability: 1.0
- Why it matters: Matches feed focus: eval.

## 24. Introducing agentic video understanding with Gemini
- Type: news | Source: google_deepmind_blog
