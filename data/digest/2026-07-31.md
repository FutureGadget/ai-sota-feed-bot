# Daily AI SOTA Digest - 2026-07-31
...
## 5. DeepSeek Retrained V4-Flash Beats Its Flagship Pro on Nine Agent Benchmarks - Tech Times
...
## 7. MCP is going stateless: What the new spec means for AI agents
- Type: news | Source: hackernews_ai
- URL: https://newrelic.com/blog/ai/mcp-is-going-stateless
...
## 14. Why Are GUI Agents Correct but Late? Decode on the Decision-Time Critical Path, Tested with Pre-Compiled Policy Trees
- Type: paper | Source: arxiv_cs_lg
- URL: http://arxiv.org/abs/2607.28399v1
- Score: 2.495 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 15. codex 0.147.0-alpha.4
...
## 20. Announcing the Agentic Catalog Experience in Amazon Quick
- Type: news | Source: aws_ml_blog
- URL: https://aws.amazon.com/blogs/machine-learning/amazon-quick-introduces-an-agentic-catalog-experience-for-seamless-data-discovery-creation-of-catalog-representations-and-semantic-inheritance-now-in-preview/
