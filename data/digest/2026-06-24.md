...
## 1. AI Is Moving up the Software Lifecycle: From Code Review to PRD Governance
...
## 3. Agent identity: a new access model for autonomous, team-wide AI | Claude
- Type: news | Source: claude_blog
- URL: https://claude.com/blog/agent-identity-access-model
- Score: 3.029 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 4. Lightweight Transformer Models for On-Device Fault Detection: A Benchmark Study on Resource-Constrained Deployment
...
## 12. Google OpenRL is an Experimental Self-hosted API for LLM Post-Training Fine-tuning
- Type: news | Source: infoq_ai_ml
...
## 16. claude-agent-sdk-python v0.2.109
...
## 18. How Loka Built a Natural, Low-Latency Voice Agent with Amazon Nova 2 Sonic
