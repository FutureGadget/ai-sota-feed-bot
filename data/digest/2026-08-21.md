...
## 4. A shot-scraper-style JSON API on Bun 1.4's new Bun.WebView
- Type: news | Source: simon_willison
...
## 5. claude-code v2.1.239
- Type: release | Source: claude_code_releases
- URL: https://github.com/anthropics/claude-code/releases/tag/v2.1.239
- Score: 2.625 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, claude code.

## 6. Azure DevOps Remote MCP Server Reaches GA, Without Support for Claude, ChatGPT, or Cursor
- Type: news | Source: infoq_ai_ml
...
## 11. codex 0.150.0-alpha.5
- Type: release | Source: openai_codex_releases
- URL: https://github.com/openai/codex/releases/tag/rust-v0.150.0-alpha.5
...
## 14. Test Agent Changes with LangSmith Preview Builds
...
## 17. IsoExec: Unified Execution to Eliminate Trainer-Inference Mismatch in SkyRL
- Type: news | Source: vllm_blog
- URL: https://vllm.ai/blog/2026-08-21-isoexec
- Score: 2.114 | Reliability: 1.0
- Why it matters: 

## 18. How agents can delegate better
...
- Score: 2.091 | Reliability: 1.0
- Why it matters: Matches feed focus: agentic.

## 19. claude-agent-sdk-python v0.2.143
...
## 20. Measuring benchmark optimization in speech recognition
- Type: research | Source: huggingface_blog
- URL: https://huggingface.co/blog/asr-benchmark-optimization
- Score: 1.841 | Reliability: 1.0
- Why it matters: 

## 21. Connecting retail demand planning to campaign and store execution
...
## 23. v0.28.0rc2: [Spec Decode] DFlash2: local convolution + candidate selector (#52816)
