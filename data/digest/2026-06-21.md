# Daily AI SOTA Digest - 2026-06-21

Focus: AI Platform Engineering

## 1. Apple Launches Core AI for Apple-Silicon Optimized On-Device Generative AI
...
## 5. Show HN: FERNme – agent memory that updates with ~zero LLM calls
- Type: news | Source: hackernews_ai
- URL: https://github.com/mirkofr/FERNme
- Score: 2.488 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 6. codex 0.142.0-alpha.9
