# Daily AI SOTA Digest - 2026-09-25

Focus: AI Platform Engineering

## 1. codex 0.157.0
- Type: release | Source: openai_codex_releases
- URL: https://github.com/openai/codex/releases/tag/rust-v0.157.0
...
## 3. GHOST-Q: Towards Studying Grounding Hallucinations Overlooked Under Same-score TradeOffs in Quantized VLMS
- Type: paper | Source: arxiv_cs_lg
- URL: http://arxiv.org/abs/2609.29999v1
- Score: 2.617 | Reliability: 1.0
- Why it matters: Matches feed focus: evaluation.

## 4. DeepSeek Harness Desktop Preview Version Officially Launched – Now Available
- Type: release | Source: search_cn_open_weight_labs
- URL: https://news.google.com/rss/articles/CBMiU0FVX3lxTE04ZmNmRnk3MlZ1ZVQ5N19wNU5MOW0xbXZiNFpRMnpnQndEWWZHNmdNOHprYTB5a1hlNVFrRHF3R053V3NyaFBQdGNZS0pmZnhteXdZ?oc=5
...
## 6. An Empirical Study of VLM Pipelines for Long-Document QA
- Type: paper | Source: arxiv_cs_cl
- URL: http://arxiv.org/abs/2609.29933v1
- Score: 2.457 | Reliability: 1.0
- Why it matters: Matches feed focus: agentic, eval.

## 7. New in LangSmith Engine: red teaming and automated testing
- Type: news | Source: langchain_blog
- URL: https://www.langchain.com/blog/langsmith-engine-v2-redteam
- Score: 2.429 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 8. claude-code v2.1.282
...
## 11. Power your agents: Gemini 3.8 Live with Live Avatar is now generally available
...
## 12. Project Swap: What happens when agents trade for us?
- Type: research | Source: anthropic_research
- URL: https://www.anthropic.com/research/project-swap
- Score: 2.396 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 13. AI-powered fuzzing with the GitHub Security Lab Taskflow Agent
...
## 14. InfoQ Launches High-Performing Teams Certification Program
- Type: news | Source: infoq_ai_ml
- URL: https://www.infoq.com/news/2026/09/high-performing-teams-program/?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=AI%2C+ML+%26+Data+Engineering
- Score: 2.289 | Reliability: 1.0
- Why it matters: 

## 15. Un-Mused: How a Single Debug Setting Bypassed macOS Security in Meta’s AI Client
- Type: news | Source: infoq_ai_ml
- URL: https://www.infoq.com/news/2026/09/meta-muse-zeroday/?utm_campaign=infoq_content&utm_source=infoq&utm_medium=feed&utm_term=AI%2C+ML+%26+Data+Engineering
- Score: 2.275 | Reliability: 1.0
- Why it matters: 

## 16. Managed Deep Agents delivers a better user experience for agents in production
- Type: news | Source: langchain_blog
- URL: https://www.langchain.com/blog/langsmith-managed-deep-agents-whats-new
- Score: 2.251 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 17. Runway’s WorldPrompt and the Engineering of Real-Time Worlds
- Type: news | Source: latent_space
- URL: https://www.latent.space/p/runway
- Score: 2.229 | Reliability: 1.0
- Why it matters: 

## 18. How to serve trillions of tokens for trillion-parameter coding agents
...
## 21. claude-agent-sdk-python v0.2.159
...
## 23. Two years of OpenAI Academy
- Type: news | Source: openai_blog
- URL: https://openai.com/index/two-years-of-openai-academy
- Score: 1.82 | Reliability: 1.0
- Why it matters: 

## 24. OpenAI extends cyber access to Ukraine for civilian defense
- Type: news | Source: openai_blog
