...
## 1. Automate Security Reviews With Claude Code
...
- Why it matters: Relevant to coding-agent automation but needs concrete harness patterns, CI/CD integration examples, and eval metrics to be actionable.
