...
## 11. Grab Builds Secure Agentic AI Workload Platform
...
## 12. RevengeBench: Reverse Engineering Code-Space Policies from Behavioral Experiments
- Type: paper | Source: arxiv_cs_lg
- URL: http://arxiv.org/abs/2606.26094v1
- Score: 2.64 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, eval.

## 13. AI Snitches Get Glitches: Towards Evading Agentic Surveillance
- Type: paper | Source: arxiv_cs_ai
- URL: http://arxiv.org/abs/2606.25836v1
- Score: 2.56 | Reliability: 1.0
- Why it matters: Matches feed focus: agentic, eval.

## 14. claude-agent-sdk-python v0.2.110
...
## 15. Accelerating Transformers Fine-Tuning with NVIDIA NeMo AutoModel
...
## 16. v0.24.0rc1: [CI/Build] Fix topk histogram build on SM75 (#46550)
