...
## 2. Faber – open-source coding agent that uses a code graph to navigate repos
...
## 6. codex rust-v0.149.0-alpha.7.2
- Type: release | Source: openai_codex_releases
- URL: https://github.com/openai/codex/releases/tag/rust-v0.149.0-alpha.7.2
...
## 9. Z.ai delays GLM 5.3 release over cybersecurity risks - BetaNews
...
## 14. Building a 100x Cheaper Trace Judge with Fireworks
