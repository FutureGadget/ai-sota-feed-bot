...
## 4. An Interview with Zhipu AI Co-founder Tang Jie by Qiushi Magazine
- Type: news | Source: search_cn_open_weight_labs
- URL: https://news.google.com/rss/articles/CBMid0FVX3lxTE5Ja3ZsSFdoWjJnaF82WFZxNDJhNDlhQmhKbU1uZmI0MWRBcTdySFBydmFGMjE3MG12bVg5d2lVbTJjbkxtMHNvZV9lNURVSUZQYXlpNUdPSGxqc2pvbVVnQzZhZFFpNkZnLUpoZTlFUTVqWWg3TnpF?oc=5
- Score: 2.347 | Reliability: 1.0
- Why it matters: 

## 5. codex rust-v0.154.0-alpha.5
- Type: release | Source: openai_codex_releases
- URL: https://github.com/openai/codex/releases/tag/rust-v0.154.0-alpha.5
- Score: 2.309 | Reliability: 1.0
- Why it matters: Matches feed focus: codex.

## 6. Google Mantis: an Agentic Vulnerability Scanning Harness for Reducing False Positives
- Type: news | Source: infoq_ai_ml
...
## 7. Zoho Launches Agent-Ready PaaS To Streamline AI-Generated Code To Production
...
- Score: 1.424 | Reliability: 1.0
- Why it matters: 

## 11. The purpose of DNS is to spread scams
- Type: news | Source: simon_willison
...
- Score: 2.136 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, evaluation.

## 13. Serving LLMs on Tenstorrent Hardware: Inside the vLLM TT Plugin
...
## 16. Formalizing Fermat's Last Theorem
...
## 17. OpenClaw Power, MacBook Simplicity: Five Days With Grok Bot
- Type: news | Source: latent_space
- URL: https://www.latent.space/p/grok-bot
- Score: 1.662 | Reliability: 1.0
- Why it matters: 

## 18. Project HydraFusion: Frontier quality via multi-model orchestration
