...
## 6. [AINews] Codex usage up >10x in 6 months to 7M users, +1M in the past ~day; did Codex overtake Claude Code??
...
## 9. How DoorDash Built an AI Shopping Assistant That Doesn’t Rely on the LLM Alone
...
## 11. claude-agent-sdk-python v0.2.117
- Type: release | Source: claude_agent_sdk_python_releases
- URL: https://github.com/anthropics/claude-agent-sdk-python/releases/tag/v0.2.117
- Score: 2.523 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 12. codex rust-v0.145.0-alpha.9
- Type: release | Source: openai_codex_releases
- URL: https://github.com/openai/codex/releases/tag/rust-v0.145.0-alpha.9
- Score: 2.448 | Reliability: 1.0
- Why it matters: Matches feed focus: codex.

## 13. How Claude's values vary by model and language
...
## 14. ResearchQA: Benchmarking Citation-Grounded Question-Answering on Scientific Papers
...
## 15. The Path to Sovereign Data: Challenges and Priorities in Local-First Computing
- Type: news | Source: infoq_ai_ml
...
## 16. 6 months to live for open models
