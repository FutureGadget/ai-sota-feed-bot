...
## 3. Presentation: From AI Agent Demo to Production: Automated Testing and Evaluation
...
## 4. DeepSeek's Huawei chip plan signals a shift to large-scale domestic AI deployments in China
- Type: news | Source: search_cn_open_weight_labs
- URL: https://news.google.?oc=5
...
## 7. GLM 5.3 Optimizations, Part 1: Hybrid HiSparse Offloading in vLLM
...
- Score: 1.368 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, eval.

## 11. The Frontier AEO Tracker: What Astra Chooses (and every other frontier model, and what you can do about it)
- Type: news | Source: latent_space
- URL: https://www.latent.space/p/aeo
- Score: 2.251 | Reliability: 1.0
- Why it matters: 

## 12. Google Mantis: an Agentic Vulnerability Scanning Harness for Reducing False Positives
- Type: news | Source: infoq_ai_ml
...
## 14. Serving LLMs on Tenstorrent Hardware: Inside the vLLM TT Plugin
- Type: news | Source: vllm_blog
...
## 16. Project HydraFusion: Frontier quality via multi-model orchestration
...
## 17. Formalizing Fermat's Last Theorem
...
- Score: 1.459 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 19. claude-code v2.1.263
- Type: release | Source: claude_code_releases
- URL: https://github.com/anthropics/claude-code/releases/tag/v2.1.263
- Score: 1.375 | Reliability: 1.0
- Why it matters: 

## 20. Introducing WeatherNext 3, our most advanced and accurate global weather AI model
