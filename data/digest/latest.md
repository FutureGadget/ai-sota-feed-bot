...
## 5. Changing the game: Using agentic AI to secure infrastructure code
...
## 6. Prediction-Powered Smoothing and Validation for Disaggregated AI Evaluation
- Type: paper | Source: arxiv_cs_lg
- URL: http://arxiv.org/abs/2609.20758v1
- Score: 2.492 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, evaluation.

## 7. claude-code v2.1.277
...
## 12. Note on 18th September 2026
- Type: news | Source: simon_willison
- URL: https://simonwillison.net/2026/Sep/18/probably-gonna-eat-you/
- Score: 2.43 | Reliability: 1.0
- Why it matters: 

## 13. OpenAI and Anthropic's Chinese Rivals Face a Revenue Reality Check
...
## 24. Enabling secure, productive work on personal devices
