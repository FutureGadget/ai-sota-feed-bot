...
## 8. codex 0.157.0-alpha.11.1
- Type: release | Source: openai_codex_releases
- URL: https://github.com/openai/codex/releases/tag/rust-v0.157.0-alpha.11.1
...
## 12. ‘Bigger than a Breadbox’ in AI. Capex, Gemini & DeepSeek. ARD #170
...
## 17. TEMPS: Temporal Sentence Embeddings for Temporal Information Retrieval
- Type: paper | Source: arxiv_cs_cl
- URL: http://arxiv.org/abs/2609.28048v1
- Score: 2.18 | Reliability: 1.0
- Why it matters: Matches feed focus: eval.

## 18. Deploy and manage coding agents at scale with the Unity Gateway CLI
