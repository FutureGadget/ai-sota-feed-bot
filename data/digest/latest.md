...
## 4. Google Agent Development Kit for Kotlin Reaches Feature Parity with Python, Supports On-Device AI
- Type: news | Source: infoq_ai_ml
...
## 7. Z.ai encrypted the workspace it uploaded so that only Z.ai could open it. Now only Z.ai can say it was deleted.
...
- Score: 1.35 | Reliability: 1.0
- Why it matters: 

## 11. Unity Ships Official Claude Code, Codex Plugins [2026]
...
- Score: 1.589 | Reliability: 1.0
- Why it matters: 

## 20. claude-agent-sdk-python v0.2.156
...
## 21. Changing the game: Using agentic AI to secure infrastructure code
