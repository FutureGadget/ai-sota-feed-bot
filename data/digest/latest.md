# Daily AI SOTA Digest - 2026-05-30
...
## 7. GitHub Slashes Agent Workflow Token Spend up to 62% with Daily Audits and MCP Pruning
...
## 9. Coding Agents Social Sciences
...
## 11. [AINews] Anthropic raises $965B Series H, releases Opus 4.8 and Dynamic Workflows/ultracode
...
## 13. RoboWits: Unexpected Challenges for Robotic Creative Problem Solving
...
## 15. ITBench-AA: Frontier Models Score Below 50% on the First Benchmark for Agentic Enterprise IT Tasks — by Artificial Analysis and IBM
- Type: research | Source: huggingface_blog
- URL: https://huggingface.co/blog/ibm-research/itbench-aa
- Score: 2.648 | Reliability: 1.0
- Why it matters: Potential relevance to AI platform engineering; verify practical impact.

## 16. Presentation: Building Evals for AI Adoption: From Principles to Practice
- Type: news | Source: infoq_ai_ml
...
## 19. I built an agent-run 1:1 email newsletter for competitive intelligence (free)
- Type: news | Source: hackernews_ai
- URL: https://rivalnewsletter.com/
