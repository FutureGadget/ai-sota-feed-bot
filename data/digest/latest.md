...
## 4. Walsh: Multi-agent research pipeline with risk manager that can veto trades
- Type: news | Source: hackernews_ai
- URL: https://github.com/ats4321/walsh
- Score: 2.494 | Reliability: 1.0
- Why it matters: Matches feed focus: agent.

## 5. DeepSeek Became the Attack Engine Because It Had the Fewest Guardrails - forkast.news
