...
## 2. Two new Showboat tools: Chartroom and datasette-showboat
- Type: news | Source: simon_willison
...
## 4. Does AI Make the Agile Manifesto Obsolete?
...
## 6. Show HN: Taking a shart at the first programming language designed for AI agents
- Type: news | Source: hackernews_ai
- URL: https://github.com/haltandcatchwater/fractal-code
- Score: 2.205 | Reliability: 1.0
- Why it matters: Potential relevance to AI platform engineering; verify practical impact.

## 7. Anthropic Rwanda Mou
...
## 10. [AINews] Qwen3.5-397B-A17B: the smallest Open-Opus class, very efficient model
...
## 11. Use What You Know: Causal Foundation Models with Partial Graphs
