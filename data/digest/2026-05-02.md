# Daily AI SOTA Digest - 2026-05-02
...
## 5. Preliminary Findings on AI Automation from Worker Evaluations
...
## 11. Evaluating Claude For Bioinformatics With Biomysterybench
...
## 13. OpenAI models, Codex, and Managed Agents come to AWS
- Type: news | Source: openai_blog
- URL: https://openai.com/index/openai-on-aws
- Score: 2.638 | Reliability: 1.0
- Why it matters: Potential relevance to AI platform engineering; verify practical impact.

## 14. Introducing Advanced Account Security
- Type: news | Source: openai_blog
...
## 17. OpenAI added virtual pets to its Codex coding agent and the design choice reveals more than it was meant to - Startup Fortune
...
## 20. AI evals are becoming the new compute bottleneck
