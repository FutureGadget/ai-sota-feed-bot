...
## 1. Local Harness Benchmark: Pi Coding Agent vs. OpenCode with Qwen3.6 35B A3B
- Type: news | Source: hackernews_ai
- URL: https://grigio.org/local-harness-benchmark-pi-coding-agent-vs-opencode/
...
## 7. OpenAI models, Codex, and Managed Agents come to AWS
- Type: news | Source: openai_blog
- URL: https://openai.com/index/openai-on-aws
- Score: 2.587 | Reliability: 1.0
- Why it matters: Potential relevance to AI platform engineering; verify practical impact.

## 8. Can Coding Agents Reproduce Findings in Computational Materials Science?
- Type: paper | Source: arxiv_cs_ai
- URL: http://arxiv.org/abs/2605.00803v1
- Score: 2.583 | Reliability: 1.0
- Why it matters: Potential relevance to AI platform engineering; verify practical impact.

## 9. Choco automates food distribution with AI agents
- Type: news | Source: openai_blog
