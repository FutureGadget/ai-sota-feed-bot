# Daily AI SOTA Digest - 2026-07-13
...
## 2. Show HN: Finterm.ai Bloomberg terminal for Claude Code
...
## 7. codex 0.145.0-alpha.7
- Type: release | Source: openai_codex_releases
- URL: https://github.com/openai/codex/releases/tag/rust-v0.145.0-alpha.7
- Score: 2.235 | Reliability: 1.0
- Why it matters: Matches feed focus: codex.

## 8. Directly Responsible Individuals (DRI)
...
## 10. Parameter-Efficient Vision-Language Adaptation with Continuous Metadata Conditioning for Animal Re-Identification
- Type: paper | Source: arxiv_cs_ai
- URL: http://arxiv.org/abs/2607.09443v1
- Score: 2.106 | Reliability: 1.0
- Why it matters: Matches feed focus: evaluation.

## 11. 6 months to live for open models
...
## 13. Launching UI for generative AI inference recommendations in Amazon SageMaker AI
...
## 14. Forget Narrowly, Retain Broadly: Unlearning as an Asymmetric Generalization Problem
