# Daily AI SOTA Digest - 2026-06-02
...
## 2. Claude Code Adds Dynamic Workflows for Parallel Agent Coordination
...
## 3. MASER: Modality-Adaptive Specialist Routing for Embodied 3D Spatial Intelligence
...
- Score: 2.952 | Reliability: 1.0
- Why it matters: Potential relevance to AI platform engineering; verify practical impact.

## 6. Show HN: MetaBrain – A local document memory for AI agents
...
## 13. Article: Why Vector Search Alone Isn't Enough: Hybrid Retrieval for RAG
- Type: news | Source: infoq_ai_ml
...
## 16. Hackers Simply Asked Meta AI to Give Them Access to High-Profile Instagram Accounts. It Worked
- Type: news | Source: simon_willison
...
## 20. Holo3.1: Fast & Local Computer Use Agents
