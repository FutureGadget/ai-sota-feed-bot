...
## 4. How Datadog Used Claude and Cursor for Test-Driven Production Migration
...
## 5. [AINews] OpenAI launches GPT 5.6 Sol/Terra/Luna, Codex becomes ChatGPT superapp
...
## 8. UST is bringing Claude to physical AI
...
## 11. AlloyDB Ships Proxy Models That Replace LLM Calls with Local Inference inside the Database
- Type: news | Source: infoq_ai_ml
...
## 15. Grok 4.5 Cuts Coding-Agent Cost 80%: Near-Frontier Speed, Higher Hallucinations - Tech Times
...
## 18. claude-agent-sdk-python v0.2.115
