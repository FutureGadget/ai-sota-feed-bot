...
## 2. Inference Chips Differ for LLM Serving Workloads - Let's Data Science
...
## 3. AI Model Context Protocol Adds Centralised Auth for Enterprise
- Type: news | Source: infoq_ai_ml
...
## 6. vLLM × HPC-Ops: High-Performance Attention and MoE Backends from Tencent Hunyuan
