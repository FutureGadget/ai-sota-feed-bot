# Daily AI SOTA Digest - 2026-06-22

Focus: AI Platform Engineering

## 1. Agent-memory systems admit poisoned facts – a reproducible benchmark
...
## 6. Execution-State Capsules: Graph-Bound Execution-State Checkpoint and Restore for Low-Latency, Small-Batch, On-Device Physical-AI Serving
- Type: paper | Source: arxiv_cs_lg
- URL: http://arxiv.org/abs/2606.20537v1
- Score: 2.8 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, eval.

## 7. AWS Graviton5 Reaches General Availability with 192 Cores and Formally Verified VM Isolation
...
## 8. Anthropic Reports Claude Now Handles 95% of Internal Analytics Queries
- Type: news | Source: infoq_ai_ml
...
## 9. Claude Code Loop Engineering: Stop Prompting, Start Designing Autonomous Agent Workflows - Tech Times
- Type: news | Source: search_agent_engineering_news
- URL: https://news.google.?oc=5
- Score: 2.554 | Reliability: 1.0
- Why it matters: Matches feed focus: agent, claude code.

## 10. ScaffoldAgent: Utility-Guided Dynamic Outline Optimization for Open-Ended Deep Research
...
## 15. NVIDIA Vera CPU Opens the Way for Agentic Scientific AI at Los Alamos National Laboratory
