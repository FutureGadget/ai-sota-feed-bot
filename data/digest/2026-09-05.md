...
## 2. Show HN: Claude Skill – Interns must review (your agent's design choices)
...
## 3. OpenAI's rogue agents were caught communicating via public wikis
- Type: news | Source: simon_willison
...
## 5. Presentation: A Few Predicted Talks From QConAI 2030
- Type: news | Source: infoq_ai_ml
...
## 6. Z.ai's New GLM-5.3-Flash Model Runs 3.3 Times Faster on a Single Workstation
...
## 14. Spanner migrations: Automating dual-write with Antigravity CLI for minimal disruption
...
## 22. v0.29.0rc4: [Bugfix] Avoid sync in TRT-LLM ragged prefill
