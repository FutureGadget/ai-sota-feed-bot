...
obstacles: []
related_storylines: []
evidence: [1f04aad16ad88e88, 473efa3d40555ca9, 860864df5583b9ff, 0971e4ffff50b51c, 435cc52d2f08f897, c69cda5ccda84a51, f133907eceb910d7, b78fb2c666f0c2da, 246a4c93052ef3c1]
updated: 2026-07-02
covers_evidence: [1f04aad16ad88e88, 473efa3d40555ca9, 860864df5583b9ff, 0971e4ffff50b51c, 435cc52d2f08f897, c69cda5ccda84a51, f133907eceb910d7, b78fb2c666f0c2da, 246a4c93052ef3c1]
---
...
- **Models** get deprecated out from under running agents — Claude Code now emits a warning when the requested model is deprecated, making model-upgrade drift an explicit, surfaced signal rather than a silent behavior change — and the same release hardened auto-mode safety (blocking destructive git commands), a reminder that the harness's *defaults* drift too. The **default** itself is now visibly moving: a later Claude Code release swapped the harness's default model to Claude Sonnet 5 (a native 1M-token context window, promotional $2/$10-per-Mtok pricing for a limited window) — an agent that never pins a model explicitly inherits a materially different context budget and price the day that release lands, with no code change on its own end.
...
## What's new
The default-model swap itself is now a visible drift event, distinct from
