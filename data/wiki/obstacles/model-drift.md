...
## What's new
The single-fix version of the SDK-drift pattern repeated at five-times the
scale: SDK 0.2.122 shipped as another "bundled CLI update" one-liner, but the
CLI it carried (v2.1.214) quietly fixed five separate permission-check
bypasses — the largest batch of security-relevant behavior change yet to ride
through disguised as a routine point release.
