...
## What's new
An open agent-security benchmark reports the attacks it fails to catch
...
Prior update: Ponytail, a coding-agent instruction-file repo that passed 44,000 GitHub
