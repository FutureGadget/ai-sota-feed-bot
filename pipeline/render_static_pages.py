...
WIKI_PAGE_CSS = """\
    ...
    .ku-hud { position:absolute; z-index:3; left:.85rem; bottom:.85rem; display:flex; gap:.35rem; }
    .ku-hud button { width:2.1rem; height:2.1rem; font-size:1rem; line-height:1; cursor:pointer;
      color:#e8f0fc; background:rgba(10,14,23,.85); border:1px solid #33415c; border-radius:2px; }
    .ku-hud button:hover { border-color:#8fd3ff; color:#8fd3ff; }
...
def wiki_universe_section(wiki: dict) -> str:
    ...
    return (
        ...
        'Drag to orbit · scroll or pinch to zoom · click a planet to see what lives there. '
        ...
        '<script type="module" src="/universe/universe.js?v=20260805"></script>'
    )
