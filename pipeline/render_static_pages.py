...
NAV_UPDATES_JS = r"""
    (function () {
      ...
      function injectStyle() {
        ...
        s.textContent = '.nav-update-dot{display:inline-block;width:.5rem;height:.5rem;margin-left:.35rem;border-radius:999px;background:#dc2626;vertical-align:middle}.nav-update-sr{position:absolute;width:1px;height:1px;margin:-1px;padding:0;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}';
